...
cp {manifest_dir}/configs/prover_config_example.toml {manifest_dir}/configs/prover_config.toml
",
...
crates/l2/configs/prover_config_example.toml
You can also see the differences with:
diff {manifest_dir}/configs/prover_config_example.toml {manifest_dir}/configs/prover_config.toml
",
        manifest_dir = env!("CARGO_MANIFEST_DIR")
